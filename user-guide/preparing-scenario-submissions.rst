...
|uncheck| The file contains a **data** sheet
   ...
   |uncheck| The sheet contains **model**, **scenario**, **region**, **variable**, and **unit** columns

   |uncheck| The sheet contains timeslice columns (e.g.: 2005, 2010, 2015, 2020, etc.)

|uncheck| The file does not contain duplicate rows or duplicate indexes (combination of model, scenario, region, variable, unit)
